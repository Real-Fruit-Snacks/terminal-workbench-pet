...
(function () {
  var mode = 'float';
  var engine = null;
  window.twpetSetMode = function (m) { mode = m; if (engine) engine.notifyModeChanged(); return mode; };
